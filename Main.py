...
import redis
from Utils import password, destination
import datetime
...
class Scraper():
    ...
    def email(self):
       ...
       msg["subject"] = "Alex's awesome news. This is a test"
       ...
       html = """
            ...
            %s
            source is: "https://news.ycombinator.com/"
...
#Check the timing, for the moment I can do it like this

if datetime.datetime.now().hour%3 == 0:
    a.parse()
    a.store()
